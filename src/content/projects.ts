...
export const projects: Project[] = [
  {
    ...
    kind: t('Brand website + 3D configurator', 'موقع شركة + قميص ثلاثي الأبعاد يصممه العميل'),
    summary: t(
      ...
      'شركة سعودية للزي الموحد: شعار وألوان جديدة، وقميص ثلاثي الأبعاد (3D) يختار العميل لونه وتطريزه، ثم يطلب السعر بما اختاره.',
    ),
  ...
  },
  {
    ...
    arName: 'نُبل — موقع عطور ثلاثي الأبعاد',
    industry: t('Perfume', 'العطور'),
    kind: t('Immersive experience', 'موقع ثلاثي الأبعاد يتفاعل معه الزائر'),
    summary: t('A luxury fragrance house told as one cinematic 3D scroll story.', 'دار عطور فاخرة، موقعها يحكي قصة العطر كفيلم قصير ثلاثي الأبعاد، يتحرك كلما نزلت في الصفحة.'),
    tags: [t('Luxury', 'فاخر'), t('Perfume', 'عطور'), t('3D', 'ثلاثي الأبعاد'), t('Interactive', 'تفاعلي')],
  ...
  },
  {
    ...
    summary: t('A specialty coffee brand with an editorial, sun-lit identity and a pinned scroll story.', 'مقهى قهوة مختصة، موقعه يشبه مجلة مشمسة وهادئة، وتتحرك قصته كلما نزلت في الصفحة.'),
    tags: [t('Café', 'مقهى'), t('Editorial', 'طابع مجلة'), t('Motion', 'حركة')],
