...
const shell = (body: string) => `<!doctype html><html><body style="margin:0;background:#0e0e0f;font-family:Segoe UI,Arial,sans-serif;color:#f5f4f0">
...
${body}
<p style="color:#5c5c61;font-size:12px;margin-top:36px">You receive this because your email is an authorised SIMA admin.</p>
</div></body></html>`;
...
<table style="width:100%;border-collapse:collapse;font-size:14px">${rows
      ...
      .join('')}</table>
<p style="color:#8c8c91;margin:22px 0 0">If this wasn't one of you, open the dashboard and sign out all sessions.</p>`),
  };
}
