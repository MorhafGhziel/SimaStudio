                ...
                <li key={item.q.en} className="border-b border-line">
                  <h3>
                    <button
                      ...
                      className="flex w-full items-center justify-between gap-6 py-6 text-start text-lg transition-colors hover:text-accent sm:text-xl"
                    >
                      {item.q[locale]}
                      <Plus className={cn('size-5 shrink-0 transition-transform duration-500 ease-out', isOpen && 'rotate-45 text-accent')} strokeWidth={1.4} />
                    </button>
                  </h3>
