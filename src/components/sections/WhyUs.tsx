  ...
  return (
    <section aria-labelledby="why-title" className="section-y border-t border-line">
      <div className="container-x grid gap-14 lg:grid-cols-12">
        ...
        <ul className="grid gap-px overflow-hidden rounded-card border border-line bg-line sm:grid-cols-2 lg:col-span-8">
          {reasons.map((r, i) => (
            <li key={r.title.en} className={i === reasons.length - 1 ? 'bg-ink sm:col-span-2' : 'bg-ink'}>
