      ...
      <div className="container-x">
        ...
        <div ref={ref} className="relative mt-16 sm:mt-24">
          ...
          <div aria-hidden="true" className="absolute bottom-0 start-[0.3rem] top-0 w-px bg-line md:inset-x-0 md:bottom-auto md:top-[0.3rem] md:h-px md:w-auto">
            <motion.div style={{ scaleY: fill }} className="absolute inset-0 origin-top bg-silver md:hidden" />
            <motion.div style={{ scaleX: fill }} className="absolute inset-0 hidden origin-left bg-silver md:block rtl:origin-right" />
          </div>
          ...
          <ol className="grid gap-14 md:grid-cols-4 md:gap-8">
            {processSteps.map((step, i) => (
              ...
              >
                <span aria-hidden="true" className="absolute start-0 top-1.5 size-[0.65rem] rounded-full border border-silver bg-ink md:top-0" />
