      ...
      <div className={cn('flex flex-col lg:col-span-4 lg:py-2', flip && 'lg:order-1')}>
        <div className="flex items-center justify-between text-sm text-mute">
          <span className="relative block overflow-hidden text-paper" dir="ltr">
            ...
            <span aria-hidden="true" className="absolute inset-0 translate-y-full text-sand transition-transform duration-700 ease-out group-hover:translate-y-0">
              {project.number}
            </span>
          </span>
          <span>
        ...
        <Link href={url} className="mt-auto inline-flex items-center gap-2 self-start pt-8 text-sm text-paper transition-colors hover:text-sand">
          {dict.work.view}
