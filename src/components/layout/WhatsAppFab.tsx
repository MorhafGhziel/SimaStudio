    ...
    <AnimatePresence>
      {visible && (
        <motion.a
          ...
          className="fixed bottom-[max(1.25rem,env(safe-area-inset-bottom))] end-5 z-40 flex h-12 items-center gap-2 overflow-hidden glass rounded-pill bg-ink-2/60 px-3.5 text-paper transition-colors hover:bg-ink-3/70"
        >
          <WhatsAppIcon className="size-5 shrink-0 text-silver" />
          <motion.span
            initial={false}
