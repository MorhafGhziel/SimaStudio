    ...
    (
      <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', background: '#050507', color: '#f3f3f6', padding: '72px 80px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <span style={{ fontSize: 84, lineHeight: 1.05, letterSpacing: -3, fontWeight: 500, color: 'rgba(243,243,246,0.55)' }}>their digital presence deserves.</span>
        </div>
        <span style={{ fontSize: 24, color: '#8d8d99' }}>Premium websites & digital experiences · Saudi Arabia</span>
      </div>
    ),
    size,
  );
