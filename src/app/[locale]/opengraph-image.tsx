...
export default function OpengraphImage() {
  return new ImageResponse(
    (
      <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', background: 'radial-gradient(60% 70% at 85% 30%, rgba(124,58,237,0.45), transparent 70%), radial-gradient(40% 50% at 70% 90%, rgba(37,99,235,0.35), transparent 70%), #08080a', color: '#f5f3ee', padding: '72px 80px' }}>
